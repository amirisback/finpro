...
public class MahasiswaJudulPaPengajuanTambahActivity extends AppCompatActivity implements DosenViewResult {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new DosenPresenter(this, MahasiswaJudulPaPengajuanTambahActivity.this);
