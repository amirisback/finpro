...
import org.d3ifcool.finpro.views.activities.details.DosenMonevDetailActivity;
...
public class DosenMonevViewAdapter extends RecyclerView.Adapter<DosenMonevViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final DosenMonevViewAdapter.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public DosenMonevViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new DosenMonevViewAdapter.ViewHolder(v);
    }
