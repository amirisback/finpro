...
public class DosenJudulPaSubdosenViewAdapter extends RecyclerView.Adapter<DosenJudulPaSubdosenViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final DosenJudulPaSubdosenViewAdapter.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public DosenJudulPaSubdosenViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new DosenJudulPaSubdosenViewAdapter.ViewHolder(v);
    }
