...
import org.d3ifcool.finpro.views.activities.details.MahasiswaInformasiDetailActivity;
...
public class MahasiswaInformasiViewAdapter extends RecyclerView.Adapter<MahasiswaInformasiViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final MahasiswaInformasiViewAdapter.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public MahasiswaInformasiViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new MahasiswaInformasiViewAdapter.ViewHolder(v);
    }
