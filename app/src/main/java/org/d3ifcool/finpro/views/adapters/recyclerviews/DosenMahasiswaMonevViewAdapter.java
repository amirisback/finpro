...
import org.d3ifcool.finpro.views.activities.details.DosenMahasiswaMonevDetailActivity;
...
public class DosenMahasiswaMonevViewAdapter extends RecyclerView.Adapter<DosenMahasiswaMonevViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final DosenMahasiswaMonevViewAdapter.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public DosenMahasiswaMonevViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new DosenMahasiswaMonevViewAdapter.ViewHolder(v);
    }
