...
import org.d3ifcool.finpro.models.dataclass.JudulPaDosen;
...
public class MahasiswaJudulPaDosenViewAdapter extends RecyclerView.Adapter<MahasiswaJudulPaDosenViewAdapter.ViewHolder> {
    ...
    @Override
    public void onBindViewHolder(final MahasiswaJudulPaDosenViewAdapter.ViewHolder holder, final int position) {
    ...
    @NonNull
    @Override
    public MahasiswaJudulPaDosenViewAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int i) {
        View v = LayoutInflater.from(parent.getContext()).inflate(layoutType, parent, false);
        return new MahasiswaJudulPaDosenViewAdapter.ViewHolder(v);
    }
