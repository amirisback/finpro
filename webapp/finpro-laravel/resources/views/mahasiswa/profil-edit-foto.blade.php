                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                ...
                                <form action="{{ route('mahasiswa.profil.foto.ubah', ['nim' => $mhsBioFoto->mhs_nim])}}" method="POST" enctype="multipart/form-data">
                                    {{csrf_field()}}
                                    {{method_field('PUT')}}
                                    <div class="form-group">
                                    <img src="{{URL::asset('/image/mhs_img/'. Session::get('session_gambar') )}}" alt="koordinator" width="200" height="200">
                                    <br><br>
