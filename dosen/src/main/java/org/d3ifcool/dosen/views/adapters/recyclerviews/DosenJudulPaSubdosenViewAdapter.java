...
import org.d3ifcool.dosen.views.activities.details.DosenJudulPaSubdosenDetailActivity;
...
public class DosenJudulPaSubdosenViewAdapter extends RecyclerView.Adapter<DosenJudulPaSubdosenViewAdapter.ViewHolder> {
    ...
    private ArrayList<Judul_pa> data;
    ...
    public void addItem(ArrayList<Judul_pa> data){
        this.data = data;
