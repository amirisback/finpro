...
import org.d3ifcool.base.interfaces.objects.KegiatanView;
import org.d3ifcool.base.interfaces.works.KegiatanWorkView;
import org.d3ifcool.base.models.Kegiatan;
import org.d3ifcool.base.models.Notifikasi;
import org.d3ifcool.base.networks.api.ApiInterfaceKegiatan;
...
public class KegiatanPresenter {
    ...
    public void createKegiatan(String kegiatan, String tanggal_mulai, String tanggal_berakhir, String pelaku, String keterangan){
        if (connectionHelper.isConnected(context)){
            ...
            ApiInterfaceKegiatan apiInterfaceKegiatan = ApiClient.getApiClient().create(ApiInterfaceKegiatan.class);
