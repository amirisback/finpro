...
import org.d3ifcool.base.interfaces.lists.KuotaDosenListView;
import org.d3ifcool.base.interfaces.works.KuotaDosenWorkView;
import org.d3ifcool.base.models.KuotaDosen;
import org.d3ifcool.base.networks.api.ApiInterfaceKuotaDosen;
...
public class KuotaDosenPresenter {
    ...
    public void createKuota(String kuota_variable, String kuota_value){
        if (connectionHelper.isConnected(context)){
            ...
            ApiInterfaceKuotaDosen apiInterfaceKuotaDosen = ApiClient.getApiClient().create(ApiInterfaceKuotaDosen.class);
