...
public class ApiUrl {
    ...
    public static final class FinproUrl {
        ...
        public static final String URL_KATEGORI_JUDUL = API_PATH + "kategori_judul";
        ...
        public static final String URL_MONEV_DETAIL = API_PATH + "monev_detail";
        // -----------------------------------------------------------------------------------------
        ...
        // -----------------------------------------------------------------------------------------
        public static final String BASE_PARAMETER = "/{parameter}";
        ...
        public static final String PARAMETER_KATEGORI_JUDUL = "/{kategori_judul}";
        ...
        public static final String PARAMETER_MONEV_DETAIL = "/{monev_detail}";
        // -----------------------------------------------------------------------------------------
        public static final String PARAMETER_QUERY_DOSEN_NAMA = "dsn_nama";
